# team-26 Platanus Hack 26: CDMX Project
...
- Joel Angel López Ramírez ([@joel-lopez-dev](https://github.com/joel-lopez-dev))
- Hector Guerrero Gutiérrez ([@Hector2016cgp](https://github.com/Hector2016cgp))
- Emilio Cruz Vargas ([@mrkombo](https://github.com/mrkombo))
- Francisco Javier Silva Castro ([@franciscosilva28](https://github.com/franciscosilva28))
...
2. Point your local `origin` at **both** repos, so a single `git push` updates each one:
   ...
   git remote set-url --add --push origin https://github.com/platanus-hack/platanus-hack-26-mx-team-26.git
